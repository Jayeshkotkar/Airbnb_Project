...
const {index,renderNewForm,showListing,createListing, getUpdate, postUpdate, deleteListing, search, reserve, reservePost} = require("../controllers/listing.js");
...
router.post("/country", wrapAsync(search));

router.get("/:id/reserve", wrapAsync(reserve));

router.post("/:id/reserve", wrapAsync(reservePost));
